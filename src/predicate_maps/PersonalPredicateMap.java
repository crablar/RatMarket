...
public class PersonalPredicateMap{
	...
	public void updateInvestmentPercentages(Player player){
		...
		map.put("55% invested", fifteen_percent_invested);
		map.put("60% invested", twenty_percent_invested);
		map.put("65% invested", twentyfive_percent_invested);
		map.put("70% invested", thirty_percent_invested);
		map.put("75% invested", thirtyfive_percent_invested);
		map.put("80% invested", forty_percent_invested);
		map.put("85% invested", fortyfive_percent_invested);
		map.put("90% invested", fifty_percent_invested);
		map.put("95% invested", fifteen_percent_invested);
